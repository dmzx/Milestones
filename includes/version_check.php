...
namespace dmzx\milestones\includes;
	...
	*/
	...
	public function check($return_version = false)
	{
		...
		if ($allow_url_fopen)
		{
			...
			$template_data = array(
				'MILESTONES_AUTHOR'				=> $this->version_data['author'],
				'MILESTONES_CURRENT_VERSION'		=> $this->current_version,
				'MILESTONES_UP_TO_DATE'			=> sprintf((!$version_up_to_date) ? $this->user->lang['MILESTONES_NOT_UP_TO_DATE'] : $this->user->lang['MILESTONES_UP_TO_DATE'], $this->version_data['title']),
				'MILESTONES_S_UP_TO_DATE'		=> $version_up_to_date,
				'MILESTONES_U_AUTHOR'			=> 'http://www.phpbb.com/community/memberlist.php?mode=viewprofile&un=' . $this->version_data['author'],
				'MILESTONES_TITLE'				=> (string) $this->version_data['title'],
				'MILESTONES_LATEST_VERSION'		=> $this->current_version,
			);
			...
			if (!$version_up_to_date)
			{
				...
				$template_data = array_merge($template_data, array(
					'MILESTONES_ANNOUNCEMENT'		=> (string) $updates['announcement'],
					'MILESTONES_DOWNLOAD'			=> (string) $updates['download'],
					'MILESTONES_LATEST_VERSION'		=> $updates['current'],
				));
			}
